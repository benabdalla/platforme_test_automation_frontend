...
@Component({
  selector: 'app-act-simplifier-sepecifique',
  templateUrl: './act-simplifier-sepecifique.component.html',
  styleUrls: ['./act-simplifier-sepecifique.component.css']
})
export class ActSimplifierSepecifiqueComponent {
